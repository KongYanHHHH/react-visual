...
function Two({ echartsObj }: { echartsObj: EchartsType }) {
    ...
    return (
        <div className="h-1/3 w-full relative p-2.5">
            <div
                ...
                before:absolute before:w-2/3 before:h-turnBorder before:bg-orange-600 before:-z-20 before:left-1/2 before:top-1/2 before:animate-spin4s before:origin-top-left 
